...
import {
  EMPTY_CURRENCY_CODE_ERROR,
  EMPTY_MERCHANT_CODE_ERROR,
  EMPTY_MINIMUM_AMOUNT_ERROR,
  EMPTY_PAYEE_NAME_ERROR,
  EMPTY_PAYEE_VPA_ERROR,
  EMPTY_TRANSACTION_AMOUNT_ERROR,
  EMPTY_TRANSACTION_ID_ERROR,
  EMPTY_TRANSACTION_NOTE_ERROR,
  EMPTY_TRANSACTION_REFERENCE_ID_ERROR,
  EMPTY_URL_ERROR,
...
export class DeepLink {
  ...
  setTransactionReferenceId(transactionReferenceId: string) {
    if (!transactionReferenceId)
      throw new Error(EMPTY_TRANSACTION_REFERENCE_ID_ERROR);
  ...
  getDeepLink(): string {
    ...
    if (this._transactionReferenceId) {
      this.appendDeepLink(
        Codes.transactionReferenceId,
        this._transactionReferenceId
      );
    }
